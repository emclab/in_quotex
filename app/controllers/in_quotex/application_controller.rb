module InQuotex
  class InQuotex::ApplicationController < ::ApplicationController
    ...
    def return_customers_by_access_right     
      access_rights, model_ar_r, has_record_access = access_right_finder('index', InQuotex.customer_class.to_s.underscore.pluralize)
    ...
    def return_projects_by_access_right     
      access_rights, model_ar_r, has_record_access = access_right_finder('index', InQuotex.project_class.to_s.underscore.pluralize)
      return [] if access_rights.blank?
      return model_ar_r #instance_eval(access_rights.sql_code) #.present?
    end
  end
